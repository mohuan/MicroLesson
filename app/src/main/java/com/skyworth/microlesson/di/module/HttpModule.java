...
import com.skyworth.microlesson.BuildConfig;
import com.skyworth.microlesson.app.AppContext;
import com.skyworth.microlesson.di.qualifier.QBaseUrl;
import com.skyworth.microlesson.model.http.api.ApiConstants;
import com.skyworth.microlesson.model.http.api.QBaseApis;
import com.skyworth.microlesson.utils.MicroUtils;
        ...
        Interceptor headerInterceptor =new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                Request build = chain.request().newBuilder()
                        ...
                        .addHeader("sid", MicroUtils.getUUID())
//                        .addHeader("ticket",)
                        .build();
